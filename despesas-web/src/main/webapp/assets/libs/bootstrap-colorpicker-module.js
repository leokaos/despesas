angular.module('colorpicker.module',[]).factory('Helper',function() {
	...
	return {
	    ...
	    getOffset: function(elem,fixedPosition) {
		    var x = 0,y = 0,scrollX = 0,scrollY = 0;
	            ...
	            setColor: function(val) {
		            ...
		            for ( var key in Helper.stringParsers) {
			            if (Helper.stringParsers.hasOwnProperty(key)) {
				            ...
				            var match = parser.re.exec(val),values = match && parser.parse(match);
				            if (values) {
        ...
        function(Helper) {
	        ...
	        return {
	            ...
	            setSlider: function(event,fixedPosition) {
		            var target = Helper.closestSlider(event.target),targetOffset = Helper.getOffset(target,fixedPosition),rect = target.getBoundingClientRect(),offsetX = event.clientX - rect.left,offsetY = event.clientY - rect.top;
	        ...
	        return {
	            ...
	            link: function($scope,elem,attrs,ngModel) {
		            ...
		            var mousemove = function(event) {
			            var left = Slider.getLeftPosition(event),top = Slider.getTopPosition(event),slider = Slider.getSlider();
		            ...
		            var getColorpickerTemplatePosition = function() {
			            var positionValue,positionOffset = Helper.getOffset(elem[0]);
