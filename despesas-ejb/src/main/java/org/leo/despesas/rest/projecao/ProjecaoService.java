...
public class ProjecaoService {
	...
	public Projecao getProjecao(@QueryParam("debitavelId") Long debitavelId, @QueryParam("dataInicial") Date dataInicial, @QueryParam("dataFinal") Date dataFinal) throws DespesasException {
