...
public class GraficoFacadeImplTest {
	...
	private String getHQL() {
		return "SELECT d.tipo.descricao , MONTH(d.pagamento) , YEAR(d.pagamento) , SUM(d.valor) FROM Despesa d " + "WHERE d.pagamento BETWEEN :dataInicial AND :dataFinal " + "GROUP BY d.tipo.descricao , MONTH(d.pagamento) , YEAR(d.pagamento)" + " ORDER BY d.tipo.descricao , YEAR(d.pagamento) , MONTH(d.pagamento) ";
	}
