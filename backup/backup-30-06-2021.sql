...
29	6	2021-07-11 00:00:00	2021-06-27 00:00:00	f
\.
...
SELECT pg_catalog.setval('despesas_db.fatura_id_seq', 29, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 949, true);
