...
906	Salario	\N	3321.00	2021-06-30	3	EURO
...
SELECT pg_catalog.setval('despesas_db.meta_id_seq', 25, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 915, true);
...
SELECT pg_catalog.setval('despesas_db.orcamento_id_seq', 26, true);
