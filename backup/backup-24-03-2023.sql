...
52	6	2023-01-11 00:00:00	2022-12-27 00:00:00	f
\.
...
SELECT pg_catalog.setval('despesas_db.fatura_id_seq', 53, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 2370, true);
