...
3199	Glovo	2023-09-11	9.10	2023-09-10	3	EURO
\.
...
SELECT pg_catalog.setval('despesas_db.fatura_id_seq', 62, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 3199, true);
