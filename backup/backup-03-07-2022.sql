...
1738	Padaria 3	2022-07-03	5.15	2022-06-30	3	EURO
...
1755	Pagamento fatura 07/2022	2022-07-04	153.40	2022-07-03	3	EURO
1756	Salario	\N	1707.00	2022-07-29	3	EURO
\.
...
SELECT pg_catalog.setval('despesas_db.fatura_id_seq', 45, true);
...
SELECT pg_catalog.setval('despesas_db.meta_id_seq', 31, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 1756, true);
