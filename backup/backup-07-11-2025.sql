...
6178	Salário Novembro 2025	\N	3003.00	2025-11-30	3	EURO
6179	IVA Novembro 2025	\N	897.00	2025-11-30	3	EURO
\.
...
SELECT pg_catalog.setval('despesas_db.cotacao_id_seq', 10, true);
...
SELECT pg_catalog.setval('despesas_db.fatura_id_seq', 104, true);
...
SELECT pg_catalog.setval('despesas_db.meta_id_seq', 46, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 6179, true);
...
SELECT pg_catalog.setval('despesas_db.orcamento_id_seq', 51, true);
