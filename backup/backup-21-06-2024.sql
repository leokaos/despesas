...
4211	Uber 1	2024-06-11	3.90	2024-06-11	3	EURO
4212	Uber 2	2024-06-11	3.50	2024-06-11	3	EURO
...
SELECT pg_catalog.setval('despesas_db.fatura_id_seq', 75, true);
...
SELECT pg_catalog.setval('despesas_db.meta_id_seq', 34, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 4223, true);
...
SELECT pg_catalog.setval('despesas_db.orcamento_id_seq', 36, true);
