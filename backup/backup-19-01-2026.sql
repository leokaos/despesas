...
19	#fff700	IVA 4 Trimestre 2025	DIVIDA	EURO	t
...
2272.40	VARIAVEL	2025-10-01 22:00:00	19
\.
...
SELECT pg_catalog.setval('despesas_db.cotacao_id_seq', 12, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 6507, true);
