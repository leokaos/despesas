...
59	6	2023-06-11 00:00:00	2023-05-28 00:00:00	f
\.
...
SELECT pg_catalog.setval('despesas_db.fatura_id_seq', 59, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 2904, true);
