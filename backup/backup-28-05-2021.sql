...
28	6	2021-06-11 00:00:00	2021-05-27 00:00:00	f
\.
...
860	Salario	\N	3321.00	2021-05-31	3	EURO
...
SELECT pg_catalog.setval('despesas_db.fatura_id_seq', 28, true);
...
SELECT pg_catalog.setval('despesas_db.meta_id_seq', 24, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 900, true);
...
SELECT pg_catalog.setval('despesas_db.orcamento_id_seq', 25, true);
...
SELECT pg_catalog.setval('despesas_db.tipo_movimentacao_id_seq', 1, true);
