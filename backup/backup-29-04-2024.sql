...
3604	Glovo 2	2024-01-05	11.05	2024-01-05	3	EURO
...
3650	Cobrir Conta	\N	300.00	2024-01-18	3	EURO
...
SELECT pg_catalog.setval('despesas_db.fatura_id_seq', 66, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 3654, true);
