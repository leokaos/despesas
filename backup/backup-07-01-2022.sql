...
1164	KAMILIA PEREIRA MUENCHEN DE	2021-11-30	200.00	2021-11-30	3	EURO
...
SELECT pg_catalog.setval('despesas_db.fatura_id_seq', 35, true);
...
SELECT pg_catalog.setval('despesas_db.movimentacao_id_seq', 1176, true);
